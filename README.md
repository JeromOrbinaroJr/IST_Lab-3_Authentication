...
## 10. Раздел «Достижения, рейтинг и программы поддержки» — документальный контроль результатов обучения (ЛП4 - Данилин Кирилл)

Реализовано локальное представление 4: **«Документальный контроль успеваемости и аттестаций, результатов обучения»**.

### 10.1 Сущности (SQLite)
